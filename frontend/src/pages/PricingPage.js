...
const plans = [
  {
    ...
    features: ["10 messages per day", "Standard responses", "Chat history"],
    cta: "Current plan",
    icon: Zap,
    featured: false,
  },
  {
    ...
    features: ["Unlimited messages", "Advanced reasoning model", "Priority support", "Chat history export"],
    cta: "Subscribe",
    icon: Brain,
    featured: false,
  },
  {
    ...
    price: "$24",
    period: "/month",
    description: "Unlock full creative potential with the most powerful model",
    features: ["Unlimited messages", "Creative + reasoning models", "Priority support", "API access", "Team collaboration"],
    cta: "Subscribe",
    icon: Palette,
    featured: true,
  },
